...
// 1. Fetch the latest evaluation
// This query joins with weights to show the employee exactly how their score was calculated
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_approval'])) {
    ...
    if ($update->execute()) {
        $success_msg = "Evaluation approved and signed!";
        header("Refresh:1");
    }
}
?>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-11">
                    ...
                    <?php if($success_msg): ?>
                        <div class="alert alert-success shadow"><?php echo $success_msg; ?></div>
                    <?php endif; ?>
                    ...
                    <?php if(!$eval): ?>
                        <div class="card shadow-lg text-center p-5">
                            <div class="p-4">
                                ...
                                <p>Please contact your Supervisor or Admin to post your performance review.</p>
                                <a href="emp_dashboard.php" class="btn btn-primary mt-3">Return to Dashboard</a>
                            </div>
                        </div>
                    <?php else: ?>
                            ...
                            <div class="card-body p-4" style="z-index: 5; position: relative;">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <p class="lead mb-0">KS Cross Asia Technology | Performance Evaluation 2026</p>
                                    </div>
                                </div>
                            </div>
